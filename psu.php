...
<body background="mb.jpg">
	...
	<center>
		...
		<div class="roun1"></div>
		<div class="h">
		<h6>SMPS Selection</h6></div>
		<div class="ram">
			<img src="ps.png" width="100px" height="100px">
		</div>
...
echo"<div class='backgro'>";
	...
	while($row = mysqli_fetch_array($r))
	{
		...
		echo "<h3>".$row['supply_volt']."</h3>";
		echo "</div>";
		echo "<div class='animated slideInRight delay-1s price1'>";
		echo "<h3>".$row['price']."</h3>";
		echo "</div>";
		echo "<form method='POST' action='smpspreview.php'>";
		...
		echo"<img src='ps12.png' width='30px' height='30px'>";
		echo"</div>";
		echo "<hr>";
		$var = $var + 1;
	}
