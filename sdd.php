...
<head>
	...
	<title>HardDriveCollection</title>
	<style>
		.heade{
			width:88%;
			height:20%;
...
<body background="mb.jpg">
	...
	<center>
		...
		<div class="roun1"></div>
		<div class="h">
		<h6>SSD Selection</h6></div>
		<div class="ram">
			<img src="ssd2.png" width="80px" height="80px">
		</div>
		...
		<h3>Disk_Size</h3></div>
		<div class="ramtype">
		<h3>DisK_Speed</h3></div>
		<div class="voltage">
		<h3>Disk_Dimension</h3></div>
		<div class="price">
		<h3>NVME</h3></div>
		<div class="price11">
		<h3>Price</h3></div>
...
echo"<div class='backgro'>";
	...
	while($row = mysqli_fetch_array($r))
	{
		...
		echo "<h3>".$row['disk_size']."</h3>";
		echo "</div>";
		echo "<div class='animated slideInRight delay-1s ramtype1'>";
		echo "<h3>".$row['disk_speed']."</h3>";
		echo "</div>";
		echo "<div class='animated slideInRight delay-1s voltage1'>";
		echo "<h3>".$row['disk_dimension']."</h3>";
		echo "</div>";
		echo "<div class='animated slideInRight delay-1s price111'>";
		echo "<h3>".$row['price']."</h3>";
		echo "</div>";
		echo "<div class='animated slideInRight delay-1s price1'>";
		echo "<h3>".$row['nvme']."</h3>";
		echo "</div>";
		echo "<form method='POST' action='ssdpreview.php'>";
		...
		echo"<img src='ssd12.png' width='30px' height='30px'>";
		echo"</div>";
		echo "<hr>";
		$var = $var + 1;
	}
