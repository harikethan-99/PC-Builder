...
<body background="mb.jpg">
	...
	<center>
		...
		<div class="roun1"></div>
		<div class="h">
		<h6>HardDisk Selection</h6></div>
		<div class="ram">
			<img src="hd.png" width="100px" height="100px">
		</div>
...
echo"<div class='backgro'>";
	...
	while($row = mysqli_fetch_array($r))
	{
		...
		echo "</div>";
		echo "<form method='POST' action='hddpreview.php'>";
		...
		echo"<img src='hd12.png' width='30px' height='30px'>";
		echo"</div>";
		echo "<hr>";
		$var = $var + 1;
	}
